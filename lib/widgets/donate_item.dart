    ...
    return Column(
      ...
      children: <Widget>[
        Container(
          ...
          padding: const EdgeInsets.only(left: 20, right: 20, top: 10, bottom: 10),//.all(10.0),
            ...
            children: <Widget>[
              ...
              RichText(
                ...
                text: new TextSpan(
                  ...
                  children: <TextSpan>[
                    new TextSpan(text: "${widget.user.name} contributed"),
                    new TextSpan(text: '  \$${widget.amount}', style: new TextStyle(fontWeight: FontWeight.bold)),
                  ],
                ),
              ),
              SizedBox(height: 5),
